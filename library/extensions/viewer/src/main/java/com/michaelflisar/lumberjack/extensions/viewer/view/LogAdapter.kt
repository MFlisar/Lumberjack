...
import com.michaelflisar.lumberjack.extensions.viewer.internal.isCurrentThemeDark
import com.qtalk.recyclerviewfastscroller.RecyclerViewFastScroller

internal class LogAdapter(
    context: Context,
    var items: List<IFileConverter.Entry>,
    var filter: String
    ...
    fun update(items: List<IFileConverter.Entry>, filter: String) {
        this.items = items
        this.filter = filter
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        //binding.tvRow.movementMethod = ScrollingMovementMethod()
    ...
    class ViewHolder(
        ...
        fun bind(item: IFileConverter.Entry, filter: String) {
            ...
            binding.tvRow.text = getHighlightedText(item.lines.joinToString("\n"), filter, true)
        }
